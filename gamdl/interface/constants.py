...
ROLE_TRANSLATION = {
    ...
    "palmas": "hand claps",
    "claps": "hand claps",
    "vocais adicionais": "additional vocals",
    "fliscorne": "flugelhorn",
    "outro instrumento": "other instrument",
    "regencia (orquestra)": "orchestra conductor",
    "orquestra de cordas": "string ensemble",
    "instrumento de corda": "string instrument",
    "outro instrumento de percussao": "other percussion",
    "sinos": "bells",
}
